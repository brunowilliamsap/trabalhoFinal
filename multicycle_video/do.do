...
add wave -group alu -radix hexadecimal sim:/t_processor/the_processor/branch_equal
add wave -group alu -radix hexadecimal sim:/t_processor/the_processor/branch_not_equal
...
WaveRestoreCursors {BEQ_NOT {205000 ps} 1} {BEQ_YES {275000 ps} 1} {BNE_YES {345000 ps} 1} {BNE_NO {415000 ps} 1}
