...
add wave -group alu -radix hexadecimal sim:/t_processor/the_processor/bequal
add wave -group alu -radix hexadecimal sim:/t_processor/the_processor/bnequal
...
add wave -group writeback -radix hexadecimal sim:/t_processor/the_processor/data_in_last_modified_register

WaveRestoreCursors {{addi $t3, $0, 5} {285384 ps} 1}
